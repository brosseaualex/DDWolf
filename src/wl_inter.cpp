...
#define TIMEY 8
	...
	VWB_Bar(0, 0, rescaledWidth, rescaledHeight - STATUSLINES + 1, VIEWCOLOR);
...
void PreloadGraphics(void)
{
	...
	VWB_DrawPicScaledCoord(((screenWidth - scaleFactor * 224) / 16) * 8, (screenHeight - scaleFactor * (STATUSLINES + 48)) / 2, GETPSYCHEDPIC);
